---
title: Introducción Básica a Python
objectives:
...
A partir de ahora, cada vez que usemos `weight_kg`, Python se referirá al **Objeto** al que apunta (en este caso, un número entero con el valor '100') y sustituirá efectivamente su valor donde se utilice la variable.
