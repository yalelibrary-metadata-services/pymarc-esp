...
![Acceder a Google Colab](pymarc_tutorial/_episodios/img/access_google_collab.png)
   
2. Crea un nuevo cuaderno pulsando el botón "New Notebook" (Nuevo cuaderno).
   
   1. Puedes cambiar el nombre del cuaderno, pulsando al lado del logo de Google Drive.

![Nuevo Cuaderno de Google Colab](pymarc_tutorial/_episodios/img/new_colab_notebook.png)

3. El primer bloque con el ícono de reproducir, usualmente es un bloque para escribir código. Puedes seguir añadiendo bloques de código o texto según tus necesidades. 

![Bloque de código o texto](pymarc_tutorial/_episodios/img/block_code_text.png)
...
![Autorizar la conexión entre Google Colab y Google Drive](pymarc_tutorial/_episodios/img/authorizing_drive_colab.png)
