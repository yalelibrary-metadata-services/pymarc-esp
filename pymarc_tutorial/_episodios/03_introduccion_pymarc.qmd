---
title: Introducción Básica a PyMarc
objectives:
- ¿Qué es MARC?
...
Si el campo no existe en ese registro, PyMARC devolverá `None`.

También puedes usar la función `.get_fields()` para obtener varios campos como una lista:
...
Esto funciona porque en PyMARC, cada campo MARC también se comporta como un pequeño diccionario, donde los subcampos están indexados por sus letras.
...
Para evitar eso, puedes usar una forma más segura:
